...
function Controller() {
    ...
    $.__views.createAccountView.add($.__views.__alloyId17);
    ...
    $.__views.school_create = Ti.UI.createTextField({
        color: "#fff",
        height: 50,
        left: 20,
        right: 20,
    ...
    $.__views.createAccountView.add($.__views.school_create);
    ...
    $.__views.major_create = Ti.UI.createTextField({
        color: "#fff",
        height: 50,
        left: 20,
        right: 20,
        ...
        autocorrect: false,
        borderWidth: 0,
        hintText: "Major/Concentration",
        id: "major_create"
    });
    $.__views.createAccountView.add($.__views.major_create);
    ...
    $.__views.createAccountView.add($.__views.__alloyId25);
    $.__views.classification_create = Ti.UI.createTextField({
        color: "#fff",
        height: 50,
        left: 20,
        right: 20,
    ...
    $.__views.createAccountView.add($.__views.classification_create);
    ...
    $.__views.createAccountView.add($.__views.__alloyId26);
    ...
    $.__views.__alloyId26.add($.__views.emailBtn);
    ...
    $.__views.__alloyId26.add($.__views.cancelBtn);
