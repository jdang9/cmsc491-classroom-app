...
//Rare exceptions to indicate a bug in the _classroomplus code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ClassroomPlus proxies.
 */
