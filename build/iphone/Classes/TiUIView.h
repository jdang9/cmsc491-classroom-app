...
/**
 Base class for all Classroom views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Classroom view hierarchy (such as wrapped iOS UIViews) was touched.
