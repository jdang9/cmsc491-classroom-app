...
/**
 Base class for all ClassroomPlus views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ClassroomPlus view hierarchy (such as wrapped iOS UIViews) was touched.
